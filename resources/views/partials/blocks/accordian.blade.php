  ...
  <div id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?>">
          ...
          <div class="my-4 full-wide <?php echo $open; ?>" data-toggle="collapse" data-target="#collapse<?php echo esc_attr($id); ?>" aria-expanded="<?php echo $val; ?>" aria-controls="collapse<?php echo esc_attr($id); ?>">
              ...
              <?php endif; ?>
                ...
                <svg class="bi bi-chevron-down" width="25px" height="25px" viewBox="0 0 16 16" fill="#a8dadc" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 01.708 0L8 10.293l5.646-5.647a.5.5 0 01.708.708l-6 6a.5.5 0 01-.708 0l-6-6a.5.5 0 010-.708z" clip-rule="evenodd"/>
                </svg>

                <svg class="bi bi-chevron-up" width="25px" height="25px" viewBox="0 0 16 16" fill="#a8dadc" xmlns="http://www.w3.org/2000/svg">
